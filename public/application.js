...
/***/ function(module, exports, __webpack_require__) {
	...
	var sessionEvents = __webpack_require__(32);
	var gameEvents = __webpack_require__(38);
	var uiNav = __webpack_require__(43);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://enigmatic-plains-94238.herokuapp.com'
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  // console.log(data);
	  api.signUp(data).then(ui.signUpYes).catch(ui.signUpNo);
	  $('#sign-up')[0].reset();
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  }).then(ui.signInYes).catch(ui.signInNo);
	  $('#sign-in')[0].reset();
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  api.changePassword(data).then(ui.changePasswordYes).catch(ui.changePasswordNo);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var instructions = __webpack_require__(10);
	...
	var signUpYes = function signUpYes() {
	  $('#sign-up').append('<div class="row"><div class="col-xs-10  alert larger" id="temp">New User Created!</div></div>');
	  $('#sign-up')[0].reset();
	};

	var signUpNo = function signUpNo() {
	  if ($('.col-xs-10')) {
	    $('.col-xs-10').remove();
	  }
	  $('#sign-up').append('<div class="row"><div class="col-xs-10 red alert" id="temp"><h3>Username already taken OR mismatched password</h3></div></div>');
	};

	var changePasswordYes = function changePasswordYes() {
	  $('#change-password').append('<div class="row"><div class="col-xs-10 alert larger" id="temp">Password Successfully Changed!</div></div>');
	  $('#change-password')[0].reset();
	};

	var changePasswordNo = function changePasswordNo() {
	  if ($('.col-xs-10')) {
	    $('.col-xs-10').remove();
	  }
	  $('#change-password').append('<div class="row"><div class="col-xs-10 red alert" id="temp"><h3>Bad Password, Please Retry</h3></div></div>');
	};

	var signInNo = function signInNo() {
	  $('#results').empty();
	  $('#sign-in').append('<div class="row"><div class="col-xs-10 red alert" id="temp"><h3>Invalid Username or Password</h3></div></div>');
	};
	...
	var signInYes = function signInYes() {
	  $('.login').hide();
	  $('.userstuff').show();
	  $('#results').empty();
	...
	module.exports = {
	  ...
	  signUpYes: signUpYes,
	  signUpNo: signUpNo,
	  changePasswordYes: changePasswordYes,
	  changePasswordNo: changePasswordNo,
	  signInNo: signInNo,
	  signInYes: signInYes
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<p>Welcome to How Many Meeples! If you haven't used the site before, you can use the above links to access our functionality. You can view and add games to our collection, record your play sessions, and look up the sessions that you've played.</p>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showMySessions = function showMySessions(event) {
	  event.preventDefault();

	  var mySessions = function mySessions(response) {
	    var sessions = [];
	    ...
	    for (var i = 0, max = response.sessions.length; i < max; i++) {
	  ...
	  api.getSessions().then(function (response) {
	    ui.mySessionsSuccess(mySessions(response)).catch(ui.problem);
	  });
	};

	// posts a new play to the server
	var recordNewSession = function recordNewSession(event) {
	  event.preventDefault();
	  var data = {};
	  ...
	  //console.log(data);
	  api.newSession(data).then(function (response) {
	...
	var updateMySession = function updateMySession(event) {
	  event.preventDefault();
	  var data = {};
	  data.session = getFormFields(event.target);
	  ...
	  // }
	  api.updateSession(data, data.session.id).then(function (response) {
	    ui.updated(response);
	...
	//destroys a session
	var destroySession = function destroySession(event) {
	  event.preventDefault();
	  var id = getFormFields(event.target);
	  api.deleteSession(id.id).then(ui.destroyed).catch(ui.destroyOrUpdateError);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var userSessions = __webpack_require__(34);
	var newSession = __webpack_require__(35);
	var updatedSession = __webpack_require__(36);
	...
	var mySessionsSuccess = function mySessionsSuccess(data) {
	  $('#results').empty();
	  //console.log(data);
	  if (data.length === 0) {
	    $('#results').append('<h3>Sadly, you do not have any sessions yet!</h3>');
	  } else {
	    var sessionsList = userSessions({ sessions: data });
	...
	var newSessionResponse = function newSessionResponse(data) {
	  $('#results').empty();
	...
	var destroyOrUpdateError = function destroyOrUpdateError() {
	  $('#results').empty();
	...
	module.exports = {
	  success: success,
	  failure: failure,
	  mySessionsSuccess: mySessionsSuccess,
	  problem: problem,
	  newSessionResponse: newSessionResponse,
	  destroyed: destroyed,
	  updated: updated,
	  destroyOrUpdateError: destroyOrUpdateError
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"session row\"><h3>Game: "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.game : stack1)) != null ? stack1.name : stack1), depth0))
	    + "</h3>\n    <div class=\"data\">Number of Players: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.players : stack1), depth0))
	    + " </div>\n    <div class=\"data\">Your Rating: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
	    + " </div>\n    <div class=\"data\">Session ID: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</div>\n  <div class=\"data\">\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </div></div>\n\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "      <div>Notes: "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.notes : stack1), depth0))
	    + "</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.sessions : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return " Your notes for this session are: "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.notes : depth0), depth0));
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "<div class=\"session row\"><h3>New game of: "
	    ...
	    + ") recorded with "
	    + alias2(alias1((depth0 != null ? depth0.players : depth0), depth0))
	    + " players,\n  and a rating of "
	    + alias2(alias1((depth0 != null ? depth0.rating : depth0), depth0))
	    + "."
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.notes : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ". You can modify this with the Session ID: "
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"session row\"><h3>Game of: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.name : stack1), depth0))
	    + " updated to have with "
	    + alias2(alias1((depth0 != null ? depth0.players : depth0), depth0))
	    + " players,\n  and a rating of "
	    + alias2(alias1((depth0 != null ? depth0.rating : depth0), depth0))
	    + ".  You can modify this with the Session ID: "
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newSession = function newSession(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/sessions/',
	    method: 'POST',
	    headers: {
	...
	var updateSession = function updateSession(data, id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showGame = function showGame(event) {
	  ...
	  var data = getFormFields(event.target);
	  //console.log(data.id);
	  api.getGame(data.id).then(function (response) {
	...
	var createGame = function createGame(event) {
	  ...
	  api.newGame(data).then(function (response) {
	    ui.gameShow(response);
	  }).catch(ui.problem);
	  $('#createGame')[0].reset();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameDisplay = __webpack_require__(40);
	var newGame = __webpack_require__(41);
	...
	var gameShow = function gameShow(response) {
	  //console.log(response);
	  $('#results').empty();
	  $('#results').append(newGame(response));
	};

	var gamesShow = function gamesShow(response) {
	  //console.log(response);
	  $('#results').empty();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"session\"><span class=\"larger\">"
	  ...
	  return "<div class=\"larger\">Game Name</div>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.games : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"session row\"><h3>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.name : stack1), depth0))
	    + " created with an ID of "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
	    + ".</h3></div>\n";
	},"useData":true});
